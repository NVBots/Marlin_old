...
#if (THERMISTORHEATER_0 == 22) || (THERMISTORHEATER_1 == 22)  || (THERMISTORHEATER_2 == 22) || (THERMISTORBED == 22) //NVBots thermistor
const short temptable_22[][2] PROGMEM = {
{   42*OVERSAMPLENR,  260  },
{   57*OVERSAMPLENR,  240  },
{   80*OVERSAMPLENR,  220  },
{   114*OVERSAMPLENR,  200  },
{   163*OVERSAMPLENR,  180  },
...
#if (THERMISTORHEATER_0 == 100) || (THERMISTORHEATER_1 == 100)  || (THERMISTORHEATER_2 == 100) || (THERMISTORBED == 100) //100k bed thermistor

const short temptable_100[][2] PROGMEM = {
// ############## BEGIN THERMISTOR TABLE ##############
{   789*OVERSAMPLENR,  73  }, // Target was 75
{   815*OVERSAMPLENR,  69  }, // Target was 70
{   835*OVERSAMPLENR,  63  }, // Target was 65
{   852*OVERSAMPLENR,  60  }, // Target was 60
{   864*OVERSAMPLENR,  55  }, // Target was 55
{   882*OVERSAMPLENR,  52  }, // Target was 50
{   901*OVERSAMPLENR,  45  }, // Target was 45
{   913*OVERSAMPLENR,  40  }, // Target was 40
{   923*OVERSAMPLENR,  35  }, // Target was 35
{   932*OVERSAMPLENR,  31  }, // Target was 30
{   943*OVERSAMPLENR,  24  }, // Target was 25
// ############### END THERMISTOR TABLE ###############
{   1023*OVERSAMPLENR,  0  },
};
#endif
...
// EC2F103A2-40113
#if (THERMISTORHEATER_0 == 103) || (THERMISTORHEATER_1 == 103)  || (THERMISTORHEATER_2 == 103) || (THERMISTORBED == 103)

const short temptable_103[][2] PROGMEM = {
{   50*OVERSAMPLENR,  200  }, // Target was None
// ############### END THERMISTOR TABLE ###############
{   216*OVERSAMPLENR,  101  }, // Target was None
{   228*OVERSAMPLENR,  97  }, // Target was None
{   254*OVERSAMPLENR,  90  }, // Target was None
{   272*OVERSAMPLENR,  87  }, // Target was None
{   297*OVERSAMPLENR,  80  }, // Target was None
{   317*OVERSAMPLENR,  77  }, // Target was None
{   349*OVERSAMPLENR,  71  }, // Target was None
{   365*OVERSAMPLENR,  66  }, // Target was None
{   408*OVERSAMPLENR,  60  }, // Target was None
{   442*OVERSAMPLENR,  56  }, // Target was None
{   460*OVERSAMPLENR,  51  }, // Target was None
{   506*OVERSAMPLENR,  46  }, // Target was None
{   545*OVERSAMPLENR,  40  }, // Target was None
{   582*OVERSAMPLENR,  37  }, // Target was None
{   628*OVERSAMPLENR,  31  }, // Target was None
{   643*OVERSAMPLENR,  26  }, // Target was None
{   702*OVERSAMPLENR,  20  }, // Target was None
{   725*OVERSAMPLENR,  19  }, // Target was None
{   769*OVERSAMPLENR,  13  }, // Target was None
{   797*OVERSAMPLENR,  5  }, // Target was None
{   824*OVERSAMPLENR,  2  }, // Target was None
// ############## BEGIN THERMISTOR TABLE ##############
{   1023*OVERSAMPLENR,  0  },
};
#endif

#if (THERMISTORHEATER_0 == 234) || (THERMISTORHEATER_1 == 234) || (THERMISTORHEATER_2 == 234) || (THERMISTORBED == 234) // Semitec 234
const short temptable_234[][2] PROGMEM = {
// ############## BEGIN THERMISTOR TABLE ##############
{   28*OVERSAMPLENR,  306  }, // Target was 305
{   31*OVERSAMPLENR,  301  }, // Target was 300
{   34*OVERSAMPLENR,  295  }, // Target was 295
{   37*OVERSAMPLENR,  290  }, // Target was 290
{   40*OVERSAMPLENR,  285  }, // Target was 285
{   43*OVERSAMPLENR,  279  }, // Target was 280
{   47*OVERSAMPLENR,  275  }, // Target was 275
{   51*OVERSAMPLENR,  270  }, // Target was 270
{   56*OVERSAMPLENR,  264  }, // Target was 265
{   60*OVERSAMPLENR,  260  }, // Target was 260
{   65*OVERSAMPLENR,  255  }, // Target was 255
{   70*OVERSAMPLENR,  250  }, // Target was 250
{   75*OVERSAMPLENR,  247  }, // Target was 245
{   84*OVERSAMPLENR,  240  }, // Target was 240
{   90*OVERSAMPLENR,  236  }, // Target was 235
{   100*OVERSAMPLENR,  230  }, // Target was 230
{   107*OVERSAMPLENR,  226  }, // Target was 225
{   118*OVERSAMPLENR,  221  }, // Target was 220
{   129*OVERSAMPLENR,  216  }, // Target was 215
{   143*OVERSAMPLENR,  210  }, // Target was 210
{   154*OVERSAMPLENR,  206  }, // Target was 205
{   170*OVERSAMPLENR,  200  }, // Target was 200
{   184*OVERSAMPLENR,  196  }, // Target was 195
{   203*OVERSAMPLENR,  190  }, // Target was 190
{   219*OVERSAMPLENR,  186  }, // Target was 185
{   240*OVERSAMPLENR,  181  }, // Target was 180
{   268*OVERSAMPLENR,  175  }, // Target was 175
{   286*OVERSAMPLENR,  171  }, // Target was 170
{   317*OVERSAMPLENR,  165  }, // Target was 165
{   339*OVERSAMPLENR,  161  }, // Target was 160
{   368*OVERSAMPLENR,  156  }, // Target was 155
{   398*OVERSAMPLENR,  151  }, // Target was 150
{   433*OVERSAMPLENR,  146  }, // Target was 145
{   471*OVERSAMPLENR,  140  }, // Target was 140
{   498*OVERSAMPLENR,  136  }, // Target was 135
{   531*OVERSAMPLENR,  132  }, // Target was 130
{   568*OVERSAMPLENR,  127  }, // Target was 125
{   610*OVERSAMPLENR,  121  }, // Target was 120
{   645*OVERSAMPLENR,  116  }, // Target was 115
{   673*OVERSAMPLENR,  112  }, // Target was 110
{   711*OVERSAMPLENR,  106  }, // Target was 105
{   745*OVERSAMPLENR,  101  }, // Target was 100
{   774*OVERSAMPLENR,  97  }, // Target was 95
{   803*OVERSAMPLENR,  91  }, // Target was 90
{   837*OVERSAMPLENR,  85  }, // Target was 85
{   854*OVERSAMPLENR,  82  }, // Target was 80
{   879*OVERSAMPLENR,  77  }, // Target was 75
{   905*OVERSAMPLENR,  70  }, // Target was 70
{   919*OVERSAMPLENR,  66  }, // Target was 65
{   939*OVERSAMPLENR,  61  }, // Target was 60
{   950*OVERSAMPLENR,  56  }, // Target was 55
{   965*OVERSAMPLENR,  51  }, // Target was 50
{   974*OVERSAMPLENR,  46  }, // Target was 45
{   986*OVERSAMPLENR,  40  }, // Target was 40
{   992*OVERSAMPLENR,  35  }, // Target was 35
{   998*OVERSAMPLENR,  30  }, // Target was 30
// ############### END THERMISTOR TABLE ###############
{   1023*OVERSAMPLENR,  0  }, // Target was 50
// ############### END THERMISTOR TABLE ###############
...
{       1008*OVERSAMPLENR       ,       10       },
{       1012*OVERSAMPLENR       ,       10       },
{       1016*OVERSAMPLENR       ,       10       },
{       1020*OVERSAMPLENR       ,       10       },
{       1023*OVERSAMPLENR       ,       0       } //safety
