...
#define ENABLE_FREEWHEEL_INTERRUPT()  TIMSK1 |= (1<<OCIE1B)
#define DISABLE_FREEWHEEL_INTERRUPT() TIMSK1 &= ~(1<<OCIE1B)
#endif
...
void enable_y_endstop(bool ignore); // enable/disable endstop checking for y-max
